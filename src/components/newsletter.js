...
export default (props) => {
    return(
        <section className="newsletter" id="newsletter">
            ...
            <form action="https://wordpressowka.us20.list-manage.com/subscribe/post?u=bc1349d1dfefba72bdd8c3974&amp;id=f8311d93e4" method="post" name="mc-embedded-subscribe-form" className="validate">
